							      		...
							      		<form method="post" action="mod_proveedores.php?id='.$renglon['id'].'&page=1" enctype="multipart/form-data">
							      			...
							      			<div class="col-md-12">
							      				...
							      				value="'.$renglon['comision'].'"
							      				 placeholder="Comisión del Proveedor" class="inpmodagreg" required>
							      			</div>
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form  method="post" action="altaproveedores.php" enctype="multipart/form-data">
			      			...
			      			<div class="col-md-12">
			      				<input type="text" name="comision" placeholder="Comisión del Proveedor" class="inpmodagreg" required>
			      			</div>
