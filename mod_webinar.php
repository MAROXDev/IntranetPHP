...
$insertar="UPDATE webinnars SET fecha='".$fecha."',nombre='".$nombre."',weburl='".$weburl."',tipo='".$tipo."',provedor='".$provedor."',visible='".$visible."' WHERE id='".$id."'";
...

{
	...
	header("location: mod_web_correcto.php");
...

{
	...
	header("location: mod_web_error.php");
