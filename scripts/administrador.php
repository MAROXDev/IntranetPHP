...
<!--***BOTÓN ADMINISTRADOR***-->
	...
	$recorridocom="SELECT * from comunicados ";

	$arraycomunicados=mysqli_query($connection,$recorridocom);
...
/*if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($searchTerm !== '') {
        ...
        $query = "SELECT * FROM `comunicados` WHERE lower(`titulo`) LIKE lower(?)";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo '<tr><td colspan="4">No existen comunicados que cumplan con estas condiciones.</td></tr>';
    }
...
<html lang="">
	<head>
		<title>Administrador Gani</title>
		<!--***INICIA CABECERA***-->
		<?php
		   ...
		   <!--***INICIA MENÚ LATERAL***-->
		    ...
		    ?>
		 	...
		 	<main class="contadmin">
		 		<div class="row">
		 			<div class="col-md-4">
			 			<h3 class="naranja avenir-medium titadmonsecc"><i class="bi bi-send-fill"></i> Comunicados</h3>
			 		</div>
   ...
   <!--                 <form id="search-form">
			 		...
			 		<div class="col-md-4">
			 			<a data-bs-toggle="modal" data-bs-target="#agregarcom">
		 			...
		 			<table class="table table-hover">
                        ...
                        <?php
                        	...
                        	$nom=1;
			    				...
			    				while ($renglon = mysqli_fetch_array($arraycomunicados))
			    					{
			    						$nom=$nom+1;
			    				echo '<tr>
			    					<td>'.$renglon['titulo'].'</td>
			    					<td>'.$renglon['fecha_creacion'].'</td>
			    					<td>'.$renglon['tipo'].'</td>
			    					<td>'.$renglon['liga'].'</td>			    								    					
			    					<td>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h2 class="modal-title fs-5 naranja">Editar Comunicado</h2>
					        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					      </div>
					      <div class="modal-body">
					      	<div class="row" style="padding: 30px;">
					      		<form method="post" action="mod_comunicado.php?id='.$renglon['id'].'" enctype="multipart/form-data">
					      			<div class="col-md-12">
					      				<input type="text" name="titulo"
					      				value="'.$renglon['titulo'].'"	
					      				 placeholder="Título del Comunicado" class="inpmodagreg" required>
					      			</div>
						        	...
						        	<div class="col-md-12">
										...
										<span class="iborrainputfile">Subir otro archivo</span>
										</label>
						        	</div>
						        ...
						        <form method="post" action="delete_comunicado.php?id='.$renglon['id'].'">
						        	<div class="col-md-12">
						        		<center>
	...
	<!--******* VENTANA MODAL AGREGAR*******-->
			<div class="modal fade" id="agregarcom" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Agregar Comunicado</h2>
			        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			      </div>
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form method="post" action="altacomunicado.php" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="titulo" placeholder="Título del Comunicado" class="inpmodagreg" required>
			      			</div>
				        	
				        	<div class="col-md-12">
				        		<select class="inpmodagreg" name="tipo" required>
					        		<option>Tipo de Comunicado</option>
					        		<option>Link</option>
					        		<option>PDF</option>
					        		<option>Imágen</option>
					        	</select>
				        	...
				        	<div class="col-md-12">
			      				<input type="text" name="link" placeholder="Link" class="inpmodagreg">
			      			</div>
				        	...
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btnagrmod">Agregar comunicado</button>
				        		</center>				        		
				        	</div>
	...
	<!--******* VENTANA MODAL EDITAR*******-->
			<div class="modal fade" id="editarcom" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Editar Comunicado</h2>
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form>
			      			<div class="col-md-12">
			      				<input type="text" name="" placeholder="Título del Comunicado" class="inpmodagreg" required>
			      			</div>
				        	...
				        	<div class="col-md-12">
			      				<input type="text" name="" placeholder="Link" class="inpmodagreg">
			      			</div>
