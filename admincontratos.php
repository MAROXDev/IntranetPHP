...
<html lang="">
	<head>
		<title>Administrador Contratos Gani</title>
		<!--***INICIA CABECERA***-->
		<?php
		   ...
		   <!--***INICIA MENÚ LATERAL***-->
		    ...
		    ?>
		 	...
		 	<main class="contadmin">
		 		<div class="row">
		 			<div class="col-md-4">
			 			<h3 class="naranja avenir-medium titadmonsecc"><i class="bi bi-send-fill"></i> Contratos Gani</h3>
			 		</div>
			 		...
			 		<div class="col-md-4">
			 			<a data-bs-toggle="modal" data-bs-target="#agregarcontrato">
			    			...
			    			<tbody>
			    				<?php 
			    					if (isset($_GET['searchTerm']) && $_GET['searchTerm'] != '') {
    									...
    									$recorridoContratos = "SELECT * FROM contratos WHERE nombre LIKE '%$searchTerm%'";
								} else {
   										$recorridoContratos="SELECT * from contratos";
								}
								$arrayContratos=mysqli_query($connection,$recorridoContratos);
								$nom=1;
								while ($renglon = mysqli_fetch_array($arrayContratos))
			    				{
			    						$nom=$nom+1;
			    				echo '<tr>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Editar Contrato</h2>
			        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			      </div>
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form  method="post" action="mod_contratos.php?id='.$renglon['id'].'" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="nombre" value="'.$renglon['nombre'].'" placeholder="Nombre del contrato" class="inpmodagreg" required>
			      			</div>
				        	...
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btnagrmod">Editar Contrato</button>
				        		</center>				        		
				        	</div>				        	
				        </form>
				        <form method="post" action="delete_contratos.php?id='.$renglon['id'].'" enctype="multipart/form-data">
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btneliminarmod">Eliminar Contrato</button>
				        		</center>				        		
				        	</div>
				        </form>
			      	</div>			        
	...
	<!--******* VENTANA MODAL AGREGAR*******-->
			<div class="modal fade" id="agregarcontrato" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Agregar Contrato</h2>
			        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			      </div>
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form method="post" action="altacontratos.php" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="nombre" placeholder="Título del Contrato" class="inpmodagreg" required>
			      			</div>
				        	...
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btnagrmod">Agregar Contrato</button>
				        		</center>				        		
				        	</div>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form>
			      			<div class="col-md-12">
			      				<input type="text" name="" placeholder="Título del Contrato" class="inpmodagreg" required>
			      			</div>
