...
echo '        </select>
            ...
            <div class="col-md-12">
              <select class="inpmodagreg" name="tipo" required id="tipo-'.$row['id'].'">
            ...
            <!-- Div del textarea para cuando el tipo no sea Documento -->
            <div class="col-md-12" id="textAreaDiv-'.$row['id'].'">
              <textarea id="textocomp" name="enlace" rows="4" cols="50" placeholder="Agregar texto">'.$row['enlace'].'</textarea>
            </div>

            <!-- Div del file input, se muestra solo si tipo = Documento -->
            <div class="col-md-12" id="fileInputDiv-'.$row['id'].'" style="display: none; margin-bottom: 10px;">
              <label for="file-3">Subir documento:</label>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function() {
          var tipoSelect = document.getElementById("tipo-'.$row['id'].'");
          var fileInputDiv = document.getElementById("fileInputDiv-'.$row['id'].'");
          var textAreaDiv = document.getElementById("textAreaDiv-'.$row['id'].'");

          function toggleFileInput() {
            if (tipoSelect.value === "Documento") {
          ...
          tipoSelect.addEventListener("change", toggleFileInput);
          toggleFileInput();
        });
      </script>
    </div>
...
';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row" style="padding: 30px;">
          <form method="post" action="altasala.php" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
              <select class="inpmodagreg" name="tipo" required id="tipo-agregarsala">
                <option>Tipo</option>
                <option>Texto</option>
                <option>Enlace</option>
                <option>Documento</option>
            ...
            <!-- Div del textarea: se mostrará si el tipo es Texto o Enlace -->
            <div class="col-md-12" id="textAreaDiv-agregarsala">
              <textarea id="textocomp" name="enlace" rows="4" cols="50" placeholder="Agregar texto"></textarea>
            </div>

            <!-- Div del file input: se mostrará solo si se selecciona Documento, con un margen inferior -->
            <div class="col-md-12" id="fileInputDiv-agregarsala" style="display: none; margin-bottom: 10px;">
              <label for="file-3">Subir documento:</label>
              <input type="file" name="file-3" id="file-3">
            </div>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function() {
          var tipoSelect = document.getElementById("tipo-agregarsala");
          var fileInputDiv = document.getElementById("fileInputDiv-agregarsala");
          var textAreaDiv = document.getElementById("textAreaDiv-agregarsala");
