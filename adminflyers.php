		 			...
		 			<table class="table table-hover">
			    			...
			    			<tbody>
			    				...
			    				if (isset($_GET['searchTerm']) && $_GET['searchTerm'] != '') {
    									...
    									$recorridoflayer = "SELECT * FROM flyers WHERE CONCAT(nombre_flyer, destino) LIKE '%$searchTerm%'";
								} else {
   										$recorridoflayer="SELECT * from flyers ";
								}
			    				
								$arrayflayer=mysqli_query($connection,$recorridoflayer);
                        	$nom=1;

			    				while ($renglon = mysqli_fetch_array($arrayflayer))
			    					{
			    						$nom=$nom+1;
			    				echo '<tr>
			    					<td>'.$renglon['nombre_flyer'].'</td>
			    					<td>'.$renglon['destino'].'</td>
			    					<td>'.$renglon['fecha'].'</td>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form method="post" action="mod_flyer.php?id='.$renglon['id'].'" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="nombre" value="'.$renglon['nombre_flyer'].'" placeholder="Nombre del Flyer" class="inpmodagreg" required>
			      			</div>			      			
			      			...
			      			<div class="col-md-12">
				        		<select class="inpmodagreg" name="destino" required>
					        		<option>'.$renglon['destino'].'</option>
				        ...
				        <form method="post" action="delete_flyers.php?id='.$renglon['id'].'" enctype="multipart/form-data">
				        	<div class="col-md-12">
				        		<center>
			...
			<div class="modal fade" id="agregarflyers" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form method="post" action="altaflyer.php" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="nombre" placeholder="Nombre del Flyer" class="inpmodagreg" required>
			      			</div>			      			
				        	...
				        	<div class="col-md-12">
				        		<p>Tamaño del Flyer 900 x 1181 px</p>
				        		<input type="file" name="file-2" id="file-2" class="inputfile inputfile-2" data-multiple-caption="{count} archivos seleccionados" multiple required/>
								<label for="file-2">
								<i class="bi bi-upload"></i>
				        	...
				        	<div class="col-md-12">
				        		<center>
				        			<button type="submit" class="btnagrmod">Agregar Flyer</button>
				        		</center>				        		
				        	</div>
