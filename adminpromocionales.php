...
<html lang="">
		   ...
		   <!--***INICIA MENÚ LATERAL***-->
		    ...
		    ?>
		 	...
		 	<main class="contadmin">
		 		<div class="row">
		 			<div class="col-md-4">
			 			<h3 class="naranja avenir-medium titadmonsecc"><i class="bi bi-send-fill"></i> Promocionales Gani</h3>
			 		</div>
			 		...
			 		<div class="col-md-4">
			 			<a data-bs-toggle="modal" data-bs-target="#agregarpromocionales">
			    			...
			    			<tbody>
			    				<?php 
			    					if (isset($_GET['searchTerm']) && $_GET['searchTerm'] != '') {
    									...
    									$recorridoPromocionales = "SELECT * FROM promocionales WHERE CONCAT(name, propietario, dominio) LIKE '%$searchTerm%'";
								} else {
   										$recorridoPromocionales="SELECT * from promocionales";
								}
								$arrayPromocionales=mysqli_query($connection,$recorridoPromocionales);
								$nom=1;

			    				while ($renglon = mysqli_fetch_array($arrayPromocionales))
			    				{
			    						$nom=$nom+1;
			    				echo '<tr>
			    					<td>'.$renglon['name'].'</td>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Editar promocional</h2>
			      ...
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form  method="post" action="mod_certificado.php?id='.$renglon['id'].'" enctype="multipart/form-data">
			      			<div class="col-md-12">
			      				<input type="text" name="nombre" value="'.$renglon['name'].'" placeholder="Nombre del promocional" class="inpmodagreg" required>
			      			</div>
			      			<div class="col-md-12">
			      				<input type="text" name="propietario" value="'.$renglon['propietario'].'" placeholder="Propietario del promocional" class="inpmodagreg" required>
			      			</div>
			      			<div class="col-md-12">
			      				<input type="text" name="dominio" value="'.$renglon['dominio'].'" placeholder="Dominio del promocional" class="inpmodagreg" required>
			      			</div>
				        	...
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btnagrmod">Editar promocional</button>
				        		</center>				        		
				        	</div>				        	
				        </form>
				        <form method="post" action="delete_certificado.php?id='.$renglon['id'].'" enctype="multipart/form-data">
				        	<div class="col-md-12">
				        		<center>
				        			<button class="btneliminarmod">Eliminar promocional</button>
				        		</center>				        		
				        	</div>
				        </form>
			      	</div>			        
	...
	<!--******* VENTANA MODAL AGREGAR*******-->
			<div class="modal fade" id="agregarpromocionales" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Agregar Promocionales</h2>
			        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			      </div>
			      <div class="modal-body">
			      	<div class="row" style="padding: 30px;">
			      		<form>			      			
			      			...
			      			<div class="col-md-12">				        		
								...
								<span class="iborrainputfile">Folder Corporativo</span>
								</label>
				        	</div>
				        	...
				        	<div class="col-md-12">
								...
								<label for="file-3">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Taza Corporativa</span>
								</label>
				        	</div>
				        	...
				        	<div class="col-md-12">
								...
								<label for="file-4">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Camisas Corporativas</span>
								</label>
				        	</div>		
				        	...
				        	<div class="col-md-12">
								...
								<label for="file-5">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Gorras Corporativas</span>
								</label>
				        	</div>		 

				        	<div class="col-md-12">
				        		<input type="file" name="file-6" id="file-6" class="inputfile inputfile-2" data-multiple-caption="{count} archivos seleccionados" multiple />
								<label for="file-6">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Bolsas Corporativas</span>
								</label>
				        	</div>	      

				        	<div class="col-md-12">
				        		<input type="file" name="file-7" id="file-7" class="inputfile inputfile-2" data-multiple-caption="{count} archivos seleccionados" multiple />
								<label for="file-7">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Pluma Corporativa</span>
								</label>
				        	</div>	 

				        	<div class="col-md-12">
				        		<input type="file" name="file-8" id="file-8" class="inputfile inputfile-2" data-multiple-caption="{count} archivos seleccionados" multiple />
								<label for="file-8">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Memoria USB</span>
								</label>
				        	</div>		

				        	<div class="col-md-12">
				        		<input type="file" name="file-9" id="file-9" class="inputfile inputfile-2" data-multiple-caption="{count} archivos seleccionados" multiple />
								<label for="file-9">
								<i class="bi bi-upload"></i>
								<span class="iborrainputfile">Mochila Corporativa</span>
								</label>
				        	</div>	
