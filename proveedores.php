		 ...
		 <div class="row">
			...
			<div class="container contproveedores">
			  <div class="row">
			  		...
			  		<?php 
					$query = "SELECT * from proveedores where categoria = 'Turístico'";
			  	 	...
			  	 	while($item = mysqli_fetch_assoc($queryResult)) {
							...
							<div class="col-md-12 cuadproveedor">
								<a href="<?php echo htmlspecialchars($item['link']); ?>" target="_blank">
									...
									<?php if ($item['comision'] !== 'NA') { ?>
                    <span class="naranja avenir-regular">
                        <?php echo htmlspecialchars($item['comision']); ?>% de comisión
                    </span>
                <?php } else { ?>
                    <br>
                <?php } ?>
            ...
            <div class="modal-body">
                <div class="row" style="padding: 30px;">
                    <form method="post" action="mod_proveedores.php?id='.$item['id'].'&page=2" enctype="multipart/form-data" id="editForm_'.$item['id'].'">
                        <div class="col-md-12">
                            <input type="text" name="nombre" id="nombre_'.$item['id'].'" value="'.$item['nombre_proveedor'].'" class="inpmodagreg" placeholder="Nombre del Proveedor" required>
                            
                        </div>

                        <div class="col-md-12">
                            <input type="text" name="tipo" id="tipo_'.$item['id'].'" value="'.$item['tipo'].'" class="inpmodagreg" placeholder="Tipo del Proveedor" required>
                            
                        </div>

                        <div class="col-md-12">
                            <input type="text" name="link" id="link'.$item['id'].'" value="'.$item['link'].'" class="inpmodagreg" placeholder="Link del Proveedor" required>
                        </div>

                        <div class="col-md-12"> 
    						<input type="text" name="comision" id="comision_'.$item['id'].'" value="'.$item['comision'].'" class="inpmodagreg" placeholder="Comisión del Proveedor" required>
...
';
		...
		<!--******* VENTANA MODAL EDITAR*******-->
			...
			<!--******* VENTANA MODAL ELIMINAR*******-->
			<div class="modal fade" id="eliminarproveedor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-sm">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h2 class="modal-title fs-5 naranja">Eliminar Proveedor</h2>
